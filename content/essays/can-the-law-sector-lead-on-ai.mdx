---
title: "Can the British law sector lead on AI?"
date: "2026-06-24"
summary: "Law is text-heavy but lacks shared standards, and Gen AI is already leaking unreliable content into legal work. What if British lawyers led on AI design, through case-lifecycle data, law ontologies, and Knowledge Assurance Protocols, rather than following the tech sector?"
...
<figure>
  <img src="/images/law-case-dataflow.png" alt="A map of the dataflow of a typical contested British legal case, showing stages from pre-case activity, client and intake, law firm operations, disclosure and evidence, negotiation and settlement, court and advocacy, through to judgment and outcomes. Each stage is spread across many different systems such as case management systems, document management systems, DocuSign, SharePoint, WeTransfer, Case Center, BAILII and email." />
  <figcaption>The dataflow of a single contested case, spread across dozens of disconnected systems. Preliminary findings from interviews with senior lawyers across British firms.</figcaption>
</figure>
